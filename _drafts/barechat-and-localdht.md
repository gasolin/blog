---
title: 網際網路斷了也想上網聊天?談談數位韌性
tags:
  - network
  - P2P
  - holepunch
# date: 2025-09-23 11:40:31
---
...
當沒有穩定連外的網際網路時，想在同個無線網路環境下繼續用 BareChat 聊天，你可以這樣做：

- **設定一個 DHT 節點作為「啟動點」**：
你可以讓同個無線網路一台電腦（比如你的筆電）先成為一個 DHT 節點，作為大家加入這個「分散式電話簿」的起始點。
