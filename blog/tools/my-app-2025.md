---
title: 目前使用的電腦應用程式 (2025)
tags:
  - tool
date: 2025-05-07 10:15:31
---
...
使用 Macbook Air M2 已二年，[延續去年的設定](tools/my-app-2024)，除了使用系統內建功能外，還得安裝一些便捷程式以提高使用效率。在此順道紀錄目前使用的應用程式。
...
- ✉️ 信箱：gmail
- 🗺️ 地圖：Google 地圖
- 👥 社群：[Facebook](https://www.facebook.com/)、[Twitter](https://twitter.com/gasolin)、Slack、Keet、Discord、Telegram
- 📝 記事：Keet（開一個私人聊天室）、[Google keep](http://keep.google.com/)
