...
const addSection = function(id, value) {
  ...
  if (sections[id] === void 0) {
    sections[id] = value;
    _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Added new section :", id);
  }
};
...
const db = {
  parseDirective,
  getConfig: () => (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.c)().pie,
  addSection,
  getSections,
  cleanupValue,
  clear,
...
let conf = (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.c)();
let width;
const height = 450;
const draw = (txt, id, _version, diagObj) => {
  var _a;
  try {
    conf = (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Rendering info diagram\n" + txt);
    ...
    _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Parsed info diagram");
    ...
    (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.i)(diagram2, height, width, conf.pie.useMaxWidth);
    ...
    let [outerStrokeWidth] = (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.B)(themeVariables.pieOuterStrokeWidth);
    ...
    _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.error("Error while rendering info diagram");
