...
const draw = (text, id, version) => {
  try {
    ...
    const { securityLevel } = (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.c)();
    let sandboxElement;
    let document;
    ...
    const root = sandboxElement !== void 0 && document !== void 0 && document !== null ? (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ys)(document) : (0,d3__WEBPACK_IMPORTED_MODULE_0__/* .select */ .Ys)("body");
    ...
    _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while rendering info diagram", e);
  }
};
const renderer = { draw };
const diagram = {
