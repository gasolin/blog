...
const parseDirective = function(statement, context, type) {
  _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.m.parseDirective(this, statement, context, type);
};
...
const addElement = (name) => {
  if (elements[name] === void 0) {
    ...
    _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Added new requirement: ", name);
  }
  latestElement = {};
...
const clear = () => {
  ...
  latestElement = {};
  elements = {};
  (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.v)();
};
const db = {
  RequirementType,
  RiskLevel,
  ...
  Relationships,
  parseDirective,
  getConfig: () => (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.c)().req,
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
  ...
  setAccTitle: _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.s,
  getAccTitle: _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.g,
  setAccDescription: _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.b,
  getAccDescription: _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.a,
  addElement,
  getElements,
  setNewElementType,
  setNewElementDocRef,
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  if (rel.type == diagObj.db.Relationships.CONTAINS) {
    svgPath.attr(
      "marker-start",
      "url(" + _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.e.getUrl(conf.arrowMarkerAbsolute) + "#" + rel.type + "_line_ending)"
    );
  } else {
    svgPath.attr("stroke-dasharray", "10,7");
    svgPath.attr(
      "marker-end",
      "url(" + _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.e.getUrl(conf.arrowMarkerAbsolute) + "#" + markers.ReqMarkers.ARROW + "_line_ending)"
    );
  }
...
const drawReqs = (reqs, graph, svgNode) => {
  Object.keys(reqs).forEach((reqName) => {
    ...
    _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Added new requirement: ", reqName);
...
const draw = (text, id, _version, diagObj) => {
  conf = (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.c)().requirement;
  diagObj.db.clear();
  ...
  (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.i)(svg, height, width, conf.useMaxWidth);
