...
/* harmony export */ });
/* harmony import */ var _styles_a893c203_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(66855);
...
/* harmony import */ var _svgDraw_95adee0a_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(98237);
...
const draw = function(text, id, _version, diagObj) {
  const conf = (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.c)().class;
  idCache = {};
  _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Rendering diagram " + text);
  ...
  for (const key of keys) {
    ...
    const node = _svgDraw_95adee0a_js__WEBPACK_IMPORTED_MODULE_7__.s.drawClass(diagram2, classDef, conf, diagObj);
    idCache[node.id] = node;
    g.setNode(node.id, node);
    _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Org height: " + node.height);
  }
  const relations = diagObj.db.getRelations();
  relations.forEach(function(relation) {
    _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.l.info(
  ...
  notes.forEach(function(note) {
    _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(`Adding note: ${JSON.stringify(note)}`);
    const node = _svgDraw_95adee0a_js__WEBPACK_IMPORTED_MODULE_7__.s.drawNote(diagram2, note, conf, diagObj);
    idCache[node.id] = node;
    g.setNode(node.id, node);
  ...
  g.nodes().forEach(function(v) {
    if (v !== void 0 && g.node(v) !== void 0) {
      _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Node " + v + ": " + JSON.stringify(g.node(v)));
  ...
  g.edges().forEach(function(e) {
    if (e !== void 0 && g.edge(e) !== void 0) {
      _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(g.edge(e)));
      _svgDraw_95adee0a_js__WEBPACK_IMPORTED_MODULE_7__.s.drawEdge(diagram2, g.edge(e), g.edge(e).relation, conf, diagObj);
    }
  });
  const svgBounds = diagram2.node().getBBox();
  const width = svgBounds.width + padding * 2;
  const height = svgBounds.height + padding * 2;
  (0,_mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.i)(diagram2, height, width, conf.useMaxWidth);
  const vBox = `${svgBounds.x - padding} ${svgBounds.y - padding} ${width} ${height}`;
  _mermaid_aad43469_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(`viewBox ${vBox}`);
...
const diagram = {
  parser: _styles_a893c203_js__WEBPACK_IMPORTED_MODULE_8__.p,
  db: _styles_a893c203_js__WEBPACK_IMPORTED_MODULE_8__.d,
  renderer,
  styles: _styles_a893c203_js__WEBPACK_IMPORTED_MODULE_8__.s,
  init: (cnf) => {
    if (!cnf.class) {
      cnf.class = {};
    }
    cnf.class.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_a893c203_js__WEBPACK_IMPORTED_MODULE_8__.d.clear();
  }
};
